...
require (
	...
	sigs.k8s.io/cluster-api v1.7.0-beta.1 // indirect
...
replace sigs.k8s.io/cluster-api-provider-ibmcloud => github.com/cjschaef/cluster-api-provider-ibmcloud v0.0.0-20240417162659-b27af85b2e57
