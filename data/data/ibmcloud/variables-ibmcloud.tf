...
variable "ibmcloud_preexisting_image" {
  type        = bool
  description = "Specifies whether an existing VPC Custom Image should be used or a new one created for installation."
  default     = false
}
...
variable "ibmcloud_vpc_image_id" {
  type        = string
  description = "The id of an existing VPC Custom Image."
  default     = null
}

variable "ibmcloud_vpc_image_offering_crn" {
  type        = string
  description = "The IBM Cloud CRN of a VPC Custom Image provided by a Private Catalog offering, to use in place of creating a Custom Image."
  default     = ""
}
