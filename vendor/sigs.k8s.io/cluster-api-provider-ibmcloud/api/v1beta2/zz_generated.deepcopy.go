...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *COSInstanceReference) DeepCopyInto(out *COSInstanceReference) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new COSInstanceReference.
func (in *COSInstanceReference) DeepCopy() *COSInstanceReference {
	if in == nil {
		return nil
	}
	out := new(COSInstanceReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VPCNetworkStatus) DeepCopyInto(out *VPCNetworkStatus) {
	*out = *in
	if in.ComputeSubnets != nil {
		...
		*out = make([]*VPCResourceStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.LoadBalancers != nil {
		in, out := &in.LoadBalancers, &out.LoadBalancers
		*out = make([]VPCLoadBalancerStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
