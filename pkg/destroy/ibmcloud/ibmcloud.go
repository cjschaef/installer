...
func (o *ClusterUninstaller) loadSDKServices() error {
	...
	if len(o.CISInstanceCRN) > 0 {
		...
		// Get the DNS Services instance CRN
		//options := o.controllerSvc.NewGetResourceInstanceOptions(o.DNSInstanceID)
		//result, _, err := o.controllerSvc.GetResourceInstance(options)
		//if err != nil {
		//	return err
		//}
		//dnsInstanceCRN := *result.CRN
		//o.Logger.Debugf("DNS Services ID: %s", o.DNSInstanceID)
		//o.Logger.Debugf("DNS Services Instance CRN: %s", dnsInstanceCRN)
