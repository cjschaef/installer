...
func (o *ClusterUninstaller) loadSDKServices() error {
	...
	if overrideURL := ibmcloudtypes.CheckServiceEndpointOverride(ibmcloudtypes.IBMCloudServiceResourceManager, o.serviceEndpoints); overrideURL != "" {
	...
	if overrideURL := ibmcloudtypes.CheckServiceEndpointOverride(ibmcloudtypes.IBMCloudServiceResourceController, o.serviceEndpoints); overrideURL != "" {
		rcOptions = overrideURL
	}
	...
	if overrideURL := ibmcloudtypes.CheckServiceEndpointOverride(ibmcloudtypes.IBMCloudServiceIAM, o.serviceEndpoints); overrideURL != "" {
		ipmOptions.URL = overrideURL
	}
	...
	if len(o.CISInstanceCRN) > 0 {
		...
		// Check for COS override endpoint once for zonesv1 and dnsrecordsv1 API calls
		overrideURL := ibmcloudtypes.CheckServiceEndpointOverride(ibmcloudtypes.IBMCloudServiceCOS, o.serviceEndpoints)
		if overrideURL != "" {
		...
		if overrideURL := ibmcloudtypes.CheckServiceEndpointOverride(ibmcloudtypes.IBMCloudServiceDNSServices, o.serviceEndpoints); overrideURL != "" {
	...
	if overrideURL := ibmcloudtypes.CheckServiceEndpointOverride(ibmcloudtypes.IBMCloudServiceVPC, o.serviceEndpoints); overrideURL != "" {
