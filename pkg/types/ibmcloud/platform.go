...
var (
	// IBMCloudOverrideServices is a set of IBM Cloud services allowed to have their endpoints overridden mapped to their override environment variable
	IBMCloudOverrideServices = map[string]string{
...
func CheckServiceEndpointOverride(ibmcloud.IBMCloudServiceName service, serviceEndpoints []configv1.IBMCloudServiceEndpoint) string {
