...
const (
	...
	// IBMCloudServiceGlobalCatalogVar is the variable name used by the IBM Cloud Terraform Provider to override the Global Catalog (Resource Catalog) endpoint.
...
type EndpointsJSON struct {
	...
	// IBMCloudEndpointGlobalCatalog contains endpoint mapping for IBM Cloud Global Catalog (Resource Catalog).
