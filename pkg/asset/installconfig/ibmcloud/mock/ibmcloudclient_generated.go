...
func (m *MockAPI) GetSSHKeyByPublicKey(ctx context.Context, publicSSHKey, region string) (*vpcv1.Key, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSSHKeyByPublicKey", ctx, publicSSHKey, region)
...
func (mr *MockAPIMockRecorder) GetSSHKeyByPublicKey(ctx, publicSSHKey, region interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSSHKeyByPublicKey", reflect.TypeOf((*MockAPI)(nil).GetSSHKeyByPublicKey), ctx, publicSSHKey, region)
}
