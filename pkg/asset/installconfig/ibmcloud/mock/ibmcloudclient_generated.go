...
func (m *MockAPI) GetSubnetByName(ctx context.Context, subnetName string) (*vpcv1.Subnet, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) GetSubnetByName(ctx, subnetName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSubnetByName", reflect.TypeOf((*MockAPI)(nil).GetSubnetByName), ctx, subnetName)
}
...
func (m *MockAPI) GetVPCs(ctx context.Context) ([]vpcv1.VPC, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVPCs", ctx)
	ret0, _ := ret[0].([]vpcv1.VPC)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAPIMockRecorder) GetVPCs(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetVPCs", reflect.TypeOf((*MockAPI)(nil).GetVPCs), ctx)
}
