...
func TestValidateServiceEndpoints(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			errorMsg: `\Q[platform.ibmcloud.serviceEndpoints[2].name: Duplicate value: "cos", platform.ibmcloud.serviceEndpoints[3].name: Invalid value: "invalid-service": not a supported override service]\E`,
		},
	}
