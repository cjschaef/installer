...
func TFVars(sources TFVarsSources) ([]byte, error) {
	...
	// Collect controlPlane boot volume information, if it exists
	var controlPlaneBootVolumeKey string
	if masterConfig.BootVolume != nil {
	...
	cfg := &config{
		...
		ControlPlaneBootVolumeKey: controlPlaneBootVolumeKey,
